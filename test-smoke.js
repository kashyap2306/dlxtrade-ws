...
// Test configuration
const PAGES_TO_TEST = [
  { name: 'Dashboard', path: 'frontend/src/pages/Dashboard.tsx' },
  { name: 'Agents Marketplace', path: 'frontend/src/pages/AgentsMarketplace.tsx' },
  { name: 'Auto-Trade', path: 'frontend/src/pages/AutoTrade.tsx' },
  { name: 'Settings', path: 'frontend/src/pages/Settings.tsx' },
  { name: 'Profile', path: 'frontend/src/pages/Profile.tsx' },
];

const COMPONENTS_TO_CHECK = [
  { name: 'ErrorBoundary', path: 'frontend/src/components/ErrorBoundary.tsx' },
  { name: 'LoadingState', path: 'frontend/src/components/LoadingState.tsx' },
  { name: 'ErrorState', path: 'frontend/src/components/ErrorState.tsx' },
];

const CONFIG_TO_CHECK = [
  { name: 'Axios Config', path: 'frontend/src/config/axios.ts' },
  { name: 'Environment Config', path: 'frontend/src/config/env.ts' },
];
