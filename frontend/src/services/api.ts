...
export const agentsApi = {
  ...
  getCrowdConsensusTrades: (limit?: number) => api.get('/agents/crowd-consensus/trades', { params: { limit } }),
  getCrowdConsensusSettings: () => api.get('/agents/crowd-consensus/settings'),
  updateCrowdConsensusSettings: (settings: any) => api.put('/agents/crowd-consensus/settings', settings),
  getCrowdConsensusStatus: () => api.get('/agents/crowd-consensus/status'),
  startCrowdConsensusAutoTrade: () => api.post('/agents/crowd-consensus/start'),
