...
import { playNotificationSound, triggerVibration } from '../utils/soundNotification';
...
const NotificationBanner: React.FC<NotificationBannerProps> = ({
  ...
  useEffect(() => {
    ...
    // Play sound if enabled (use utility function)
    if (soundEnabled) {
      // Determine notification type from banner type/title
      let notificationType = 'autoTradeExecuted';
      if (title?.includes('Confirmation')) {
        notificationType = 'pendingTradeConfirmation';
      }
  ...
  }, [duration, onClose, soundEnabled, vibrationEnabled, hasTriggered]);
