...
import { handleNotification as handleNotificationSound } from '../utils/soundNotification';
...
export default function NotificationToast() {
  ...
  useEffect(() => {
    const handleNewNotification = (event: CustomEvent<Notification>) => {
      ...
      // Handle sound and vibration using utility
      const notificationType = event.detail.type || 'info';
      handleNotificationSound(notificationType, event.detail);
