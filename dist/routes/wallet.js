    ...
    fastify.get('/balances', {
        ...
        try {
            ...
            if (!adapter.getAccount) {
                logger_1.logger.warn({ exchange, uid: user.uid }, 'Exchange adapter does not support balance fetching');
            ...
            try {
                ...
                logger_1.logger.error({ err: adapterErr, exchange, uid: user.uid }, 'Error calling adapter.getAccount');
