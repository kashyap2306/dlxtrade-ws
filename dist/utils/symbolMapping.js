...
exports.GOOGLE_FINANCE_RATES = void 0;
exports.getCoinGeckoId = getCoinGeckoId;
exports.addCoinGeckoMapping = addCoinGeckoMapping;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
let COINGECKO_SYMBOL_MAPPINGS = {};
// Load mappings from config file
function loadCoinMappings() {
    try {
