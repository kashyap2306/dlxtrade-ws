...
exports.analyzeFundingRate = analyzeFundingRate;
exports.analyzeOpenInterest = analyzeOpenInterest;
exports.analyzeLiquidations = analyzeLiquidations;
/**
 ...
 * - Near zero → Neutral
 */
function analyzeFundingRate(data) {
 ...
 * - Balanced → Neutral
 */
function analyzeLiquidations(data) {
