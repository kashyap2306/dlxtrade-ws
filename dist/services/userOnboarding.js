...
async function ensureUser(uid, profileData) {
    ...
    try {
        ...
        logger_1.logger.info({ uid, email: profileData?.email }, 'Starting user onboarding (ensureUser)');
        ...
        if (!existingUser.exists) {
            ...
            logger_1.logger.info({ uid, createdNew: false }, '✅ User document exists');
        }
        ...
        if (!existingApiKeys.exists) {
            ...
            logger_1.logger.info({ uid }, 'API keys document created');
        }
