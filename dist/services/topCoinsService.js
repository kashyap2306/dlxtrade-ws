...
exports.topCoinsService = exports.TopCoinsService = void 0;
...
class TopCoinsService {
    ...
    async getTop100Coins() {
        try {
            ...
            const timeoutPromise = new Promise((_, reject) => setTimeout(() => reject(new Error('Symbol cache timeout')), 1000));
            const validSymbolsPromise = (0, fetchValidBinanceSymbols_1.getValidSymbols)();
            ...
            logger_1.logger.error({ err: error.message }, 'Failed to load valid symbols cache, using minimal fallback');
...
exports.TopCoinsService = TopCoinsService;
exports.topCoinsService = new TopCoinsService();
